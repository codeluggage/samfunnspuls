<!-- GENERATED FROM .agents/rules/designsystem.md. DO NOT EDIT DIRECTLY. -->
...
- Give design-system form controls stable `id` and `name` props, in addition to an accessible name, so rendered fields pass browser accessibility inspection.
